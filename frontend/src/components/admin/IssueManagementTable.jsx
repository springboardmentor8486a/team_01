                ...
                <div className="table-container-wrapper">
                    ...
                    <table>
                        ...
                        <tbody>
                            {issues.map(issue => (
                                <tr key={issue.id}>
                                    <td><div className="issue-title">{issue.title}</div><div className="issue-location">{issue.location}</div></td>
